...
function TimeTable({courses}: {courses: FormattedCoursesProps[] | undefined}) {
    return (
        <div className="container mx-auto px-4 py-8">
        <Card>
          <CardHeader>
            <CardTitle className="text-2xl text-center">Weekly Timetable</CardTitle>
          </CardHeader>
          <CardContent>
              ...
              <table className="w-full border-collapse">
                ...
                {courses?.map(course => (
                    ...
                    >
                        ...
                        <td className="p-3 border">{course.building + " " + course.room}</td>
                  </tr>
                ))}
                </tbody>
              </table>
